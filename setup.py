...
NAME = "ZenPacks.Darkemon.ZenCustomMap"
VERSION = "3.0"
AUTHOR = "Krasotin Artem / Robert Martin"
LICENSE = ""
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.Darkemon']
PACKAGES = ['ZenPacks', 'ZenPacks.Darkemon', 'ZenPacks.Darkemon.ZenCustomMap']
INSTALL_REQUIRES = []
